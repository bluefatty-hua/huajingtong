...
/usr/bin/python script/py_script/run_sql.py -f dw/yy/dw_yy_month.sql

/usr/bin/python script/py_script/run_sql.py -f rpt/yy/rpt_yy_month.sql
/usr/bin/python script/py_script/run_sql.py -f rpt/yy/rpt_yy_day.sql
