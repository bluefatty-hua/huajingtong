...
/usr/bin/python script/py_script/run_sql.py -f dw/yy/dw_yy_month_new.sql -m $this_month
/usr/bin/python script/py_script/run_sql.py -f dw/yy/dw_yy_month_guild.sql -m $this_month
...
/usr/bin/python script/py_script/run_sql.py -f rpt/yy/rpt_yy_anchor.sql -m $this_month
...
# #留存数据更新了，全部报表都要刷一遍
/usr/bin/python script/py_script/run_sql.py -f rpt/yy/rpt_yy_day.sql -m $r120_month
/usr/bin/python script/py_script/run_sql.py -f rpt/yy/rpt_yy_month.sql -m $r120_month

/usr/bin/python script/py_script/run_sql.py -f rpt/yy/rpt_yy_day.sql -m $r90_month
/usr/bin/python script/py_script/run_sql.py -f rpt/yy/rpt_yy_month.sql -m $r90_month

/usr/bin/python script/py_script/run_sql.py -f rpt/yy/rpt_yy_day.sql -m $r60_month
/usr/bin/python script/py_script/run_sql.py -f rpt/yy/rpt_yy_month.sql -m $r60_month

/usr/bin/python script/py_script/run_sql.py -f rpt/yy/rpt_yy_day.sql -m $r30_month
/usr/bin/python script/py_script/run_sql.py -f rpt/yy/rpt_yy_month.sql -m $r30_month
