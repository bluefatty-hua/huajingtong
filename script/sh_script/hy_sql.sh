...
# /usr/bin/python /services/xjl_etl/script/py_script/run_sql.py -f dw/delete_dw_hy_anchor_tags.sql

/usr/bin/python /services/xjl_etl/script/py_script/run_his_sql.py -f dw/dw_hy_day.sql
