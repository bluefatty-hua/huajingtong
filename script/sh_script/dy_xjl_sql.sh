...
/usr/bin/python /services/xjl_etl/script/py_script/run_sql.py  -f dw/dw_dy_xjl_day_recruit.sql
/usr/bin/python /services/xjl_etl/script/py_script/run_sql.py  -f rpt/rpt_dy_xjl_day_recruit.sql
