...
INSERT INTO `rpt_day_all_new_compare`
(dt,idx,yy_val)
SELECT dt,'主播数',anchor_cnt FROM  `rpt_day_all_new`  
...
INSERT INTO `rpt_day_all_new_compare`
(dt,idx,yy_val)
SELECT dt,'开播数',live_cnt FROM  `rpt_day_all_new`  
where dt >= '{start_date}' and dt<='{end_date}' and
platform = 'YY' and revenue_level = 'all' and newold_state = 'all' and active_state = 'all'
ON DUPLICATE KEY UPDATE yy_val=values(yy_val);
...
INSERT INTO `rpt_day_all_new_compare`
(dt,idx,yy_val)
SELECT dt,'流水',revenue FROM  `rpt_day_all_new`  
where dt >= '{start_date}' and dt<='{end_date}' and
platform = 'YY' and revenue_level = 'all' and newold_state = 'all' and active_state = 'all'
ON DUPLICATE KEY UPDATE yy_val=values(yy_val);
...
INSERT INTO `rpt_day_all_new_compare`
(dt,idx,yy_val)
SELECT dt,'开播人均流水',if(live_cnt>0,revenue/live_cnt,0) FROM  `rpt_day_all_new`  
where dt >= '{start_date}' and dt<='{end_date}' and
platform = 'YY' and revenue_level = 'all' and newold_state = 'all' and active_state = 'all'
ON DUPLICATE KEY UPDATE yy_val=values(yy_val);
...
INSERT INTO `rpt_day_all_new_compare`
(dt,idx,yy_val)
SELECT dt,'时长',duration FROM  `rpt_day_all_new`  
where dt >= '{start_date}' and dt<='{end_date}' and
platform = 'YY' and revenue_level = 'all' and newold_state = 'all' and active_state = 'all'
ON DUPLICATE KEY UPDATE yy_val=values(yy_val);
...
INSERT INTO `rpt_day_all_new_compare`
(dt,idx,yy_val)
SELECT dt,'开播率',if(anchor_cnt>0,round(live_cnt*100/anchor_cnt,0),0) FROM  `rpt_day_all_new`  
where dt >= '{start_date}' and dt<='{end_date}' and
platform = 'YY' and revenue_level = 'all' and newold_state = 'all' and active_state = 'all'
ON DUPLICATE KEY UPDATE yy_val=values(yy_val);
...
INSERT INTO `rpt_day_all_new_compare`
(dt,idx,yy_val)
SELECT dt,'开播人均时长',if(live_cnt>0,round(duration/live_cnt,0),0) FROM  `rpt_day_all_new`  
where dt >= '{start_date}' and dt<='{end_date}' and
platform = 'YY' and revenue_level = 'all' and newold_state = 'all' and active_state = 'all'
ON DUPLICATE KEY UPDATE yy_val=values(yy_val);
