...
-- 补充汇总数据
REPLACE INTO bireport.rpt_day_dy_guild_new (dt, platform_id, platform, backend_account_id, revenue_level, newold_state,
...
-- 报表用，计算上周、上月同期数据---
REPLACE INTO bireport.rpt_day_dy_guild_new_view
SELECT t1.dt,
...
FROM bireport.rpt_day_dy_guild_new t1
         LEFT JOIN bireport.rpt_day_dy_guild_new t2
         ...
         LEFT JOIN bireport.rpt_day_dy_guild_new t3
...
-- 报表用，计算指标占比---
REPLACE INTO bireport.rpt_day_dy_guild_new_view_compare
SELECT *
FROM (SELECT dt,
             backend_account_id,
             revenue_level,
