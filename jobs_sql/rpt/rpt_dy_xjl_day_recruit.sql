...
SELECT MIN(dt)     AS dt,
       ...
       CONCAT('<br><img title="',f_htmlchinese('主播数'),'" style="height:22px" src="/images/181548.svg" />:', MAX(anchor_cnt),
              '<br><img title="',f_htmlchinese('新开播'),'" style="height:22px" src="/images/new_black.svg" />:', SUM(new_live_cnt),
       ...
       MAX(IF(xjl_day_of_week = 0,
              CONCAT(RIGHT(dt, 5), '<br>', '<img title="',f_htmlchinese('主播数'),'" style="height:22px" src="/images/181548.svg"  />:',
                     anchor_cnt, '<br><img title="',f_htmlchinese('新开播'),'" style="height:22px" src="/images/new_black.svg" />:', new_live_cnt,
