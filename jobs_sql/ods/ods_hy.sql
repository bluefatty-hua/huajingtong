...
DELETE
FROM warehouse.ods_huya_day_guild_live_revenue
WHERE dt BETWEEN '{start_date}' AND '{end_date}';
...
DELETE
FROM warehouse.ods_huya_day_guild_live_income_gift
WHERE dt BETWEEN '{start_date}' AND '{end_date}';
...
DELETE
FROM warehouse.ods_huya_day_guild_live_income_guard
WHERE dt BETWEEN '{start_date}' AND '{end_date}';
...
DELETE
FROM warehouse.ods_huya_day_guild_live_income_noble
WHERE dt BETWEEN '{start_date}' AND '{end_date}';
