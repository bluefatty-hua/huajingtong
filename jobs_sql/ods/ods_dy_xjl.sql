-- DROP TABLE IF EXISTS warehouse.ods_dy_xjl_day_anchor_info;
-- CREATE TABLE warehouse.ods_dy_xjl_day_anchor_info AS
DELETE
FROM warehouse.ods_dy_xjl_day_anchor_info
WHERE dt BETWEEN '{start_date}' AND '{end_date}';
INSERT INTO warehouse.ods_dy_xjl_day_anchor_info
SELECT ad.dt,
       1005              AS platform_id,
       ...
       ad.punished,
       ad.timestamp
FROM spider_dy_xjl_backend.anchor_detail ad
WHERE dt BETWEEN '{start_date}' AND '{end_date}'
;


-- DROP TABLE IF EXISTS warehouse.ods_dy_xjl_day_anchor_live_duration;
-- CREATE TABLE warehouse.ods_dy_xjl_day_anchor_live_duration AS
DELETE
FROM warehouse.ods_dy_xjl_day_anchor_live_duration
WHERE dt BETWEEN '{start_date}' AND '{end_date}';
INSERT INTO warehouse.ods_dy_xjl_day_anchor_live_duration
SELECT ad.dt,
       1005                 AS platform_id,
       'DouYin'             AS platform_name,
       ad.backend_account_id,
       ...
       ad.fan_rise,
       ad.timestamp
FROM spider_dy_xjl_backend.anchor_data ad
WHERE ad.dt BETWEEN '{start_date}' AND '{end_date}'
;


-- DROP TABLE IF EXISTS warehouse.ods_dy_xjl_day_anchor_live;
-- CREATE TABLE warehouse.ods_dy_xjl_day_anchor_live AS
DELETE
FROM warehouse.ods_dy_xjl_day_anchor_live
WHERE dt BETWEEN '{start_date}' AND '{end_date}';
INSERT INTO warehouse.ods_dy_xjl_day_anchor_live
SELECT ai.dt,
       ai.platform_id,
       ai.platform_name,
