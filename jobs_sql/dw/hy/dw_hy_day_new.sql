...
UPDATE warehouse.dw_huya_day_anchor_live t1,
warehouse.dw_huya_day_anchor_live t2
...
-- -- 首次开播
-- update warehouse.dw_huya_day_anchor_live t1,
-- (SELECT anchor_uid,MIN(dt)  as dt FROM warehouse.dw_huya_day_anchor_live
...
-- 首次开播后的算为老主播
-- update warehouse.dw_huya_day_anchor_live t1, warehouse.dw_huya_day_anchor_live t2
-- set t1.add_loss_state = 'old'
