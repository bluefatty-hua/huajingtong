...
UPDATE warehouse.dw_yy_month_anchor_live t1,
warehouse.dw_yy_month_anchor_live t2
...
-- 首次开播
update warehouse.dw_yy_month_anchor_live t1,
(SELECT anchor_uid,concat(left(MIN(dt),7),'-01')  as dt FROM warehouse.dw_yy_day_anchor_live
...
-- 首次开播后的算为老主播
-- update warehouse.dw_yy_month_anchor_live t1, warehouse.dw_yy_month_anchor_live t2
-- set t1.add_loss_state = 'old'
