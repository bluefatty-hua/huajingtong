use warehouse;
delete from dw_dy_xjl_day_anchor_live_recruit where dt BETWEEN '{start_date}' AND '{end_date}';
...
LEFT OUTER JOIN 
(SELECT anchor_uid,MIN(dt) AS first_live_date FROM dw_dy_xjl_day_anchor_live
WHERE duration>3600
