...
DROP TABLE IF EXISTS warehouse.dw_sum_hy_pf_an_mon;
CREATE TABLE warehouse.dw_sum_hy_pf_an_mon AS
...
-- 汇总维度 月
-- 汇总指标 主播数，开播主播数，主播收入
DROP TABLE IF EXISTS warehouse.dw_sum_hy_mon;
CREATE TABLE warehouse.dw_sum_hy_mon AS
SELECT YEAR(t.dt)                                                                 AS rpt_year,
       MONTH(t.dt)                                                                AS rpt_month,
       t.platform_id,
       t.platform_name,
